...
@section('content')
  ...
  <div class="row d-flex justify-content-center  mt-0">
    <div class="col-md-6 ">
      <h3 class="h4 text-center mt-4 mb-0 p-0">Tmbah Hutang dari bapak {{ $hutang->pelanggan->nama }}</h3>
      <div class="card">
  ...
  <div class="container mt-2">
    <div class="row d-flex justify-content-center">
      <div class="col-md-8">
        {!! Form::open(['route' => ['tambah.hutang', $hutang->id], 'method' => 'PUT']) !!}
        <div class="mb-3">
          {{ Form::label('tanggal_hutang', 'Tanggal') }}
          {!! Form::date('tanggal_hutang', now(), ['class' => 'form-control', 'disabled']) !!}
        ...
        <div class="mb-3">
          ...
          {!! Form::date('tanggal_jatuh_tempo', now()->addDays(7), ['class' => 'form-control', 'disabled']) !!}
          <span class="text-danger"></span>
        </div>
        <div class="mb-3">
