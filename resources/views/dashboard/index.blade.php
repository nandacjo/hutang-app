  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="text-center d-flex justify-content-start gap-2">
                  ...
                  <tbody>
                    @foreach ($listHutang as $item)
                      <tr>
                        ...
                        <td>
                          <a href="/list/{{ $item->id }}/pembayaran" class="btn btn-sm btn-info">List Pembayaran</a>
                        </td>
                        <td>{{ formatRupiah($item->jumlah_hutang, true) }}</td>
                        <td>{{ $item->status }}</td>
                        <td>
                          ...
                          <a href="{{ route('transaksi.bayar.hutang.edit', $item->id) }}"
                            class="btn btn-sm btn-primary">Tambah Hutang</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
