      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col">
              ...
              <div>
                ...
                <h5 class="fw-bold">Tanggal Transaksi : <span class="text-muted">
                    {{ $model->created_at->translatedFormat('l, d-m-Y') }}</span></h5>
                <h5 class="fw-bold">Tanggal Update : <span class="text-muted">
                    {{ $model->updated_at->translatedFormat('l, d-m-Y') }}</span></h5>
          ...
          <div class="text-center mt-4">
            <a href="#" class="btn fw-bold btn-secondary btn-sm px-3 py-1 rounded"> <i class="align-middle"
                data-feather="arrow-left"></i>
              Kembali</a>
            <a href="#" class="btn fw-bold btn-primary btn-sm px-3 py-1 rounded"> <i class="align-middle"
                data-feather="printer"></i>
              Print</a>

            <a href="#" class="btn fw-bold btn-success btn-sm px-3 py-1 rounded"> <i class="align-middle"
